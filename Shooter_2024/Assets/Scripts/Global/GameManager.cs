...
public class GameManager : MonoBehaviour
{
    ...
    private List<EnemySpawnerOnTrigger> triggerSpawners;
    ...
    private void Awake()
    {
        ...
        instance.triggerSpawners = new List<EnemySpawnerOnTrigger>();
        if (instance.player)
        {
    ...
    private void UpdateStage()
    {
        ...
        if (MainPlayer && MainPlayer.OutOfLives)
        {
            GameEnd(false);
        }
    ...
    /// <summary>
    /// Register turret spawners to allow for spawning turrets on screen at start of game
    /// </summary>
    public static void RegisterTriggerSpawner(EnemySpawnerOnTrigger spawner)
    {
        instance.triggerSpawners.Add(spawner);
    }
    ...
    public static void GameStart()
    {
        ...
        for (int i = 0; i < instance.triggerSpawners.Count; i++)
        {
            instance.triggerSpawners[i].GameRestart();
        }
    }
    ...
    public void GameRestart()
    {
        ...
        for (int i = 0; i < triggerSpawners.Count; i++)
        {
            triggerSpawners[i].GameRestart();
        }
